...
const All = () => {
  const { setOpenBag } = useContext(AllContext);
    ...
    <>
      ...
      <div className=" box cursor-pointer">
        <div className="relative h-[40vh] md:h-[45vh] lg:h-[55vh]">
          <img className="img1 object-cover w-full h-full" src={img1} alt="" />
          <img className="img2 w-full h-full" src={img2} alt="" />
          <button
            onClick={handleBtn}
            className="add_cart absolute bg-white w-44 lg:w-2/3 left-6 lg:left-16 py-2 hover:bg-gray-500 hover:text-white font-medium"
          >
            {' '}
            ADD TO CART
          </button>
